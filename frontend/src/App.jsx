  ...
  return (
    <div style={layout.twoCol}>
      ...
      <div style={layout.col}>
        ...
        <div style={{ marginTop: "1rem" }}>
          <Toggle
            label="Ensemble (ResNet50 + VGG16 + DenseNet121)"
            value={ensemble}
  ...
  return (
    <div style={layout.twoCol}>
      ...
      <div style={layout.col}>
        ...
        <div style={{ marginTop: "1rem" }}>
          <Toggle
            label="Targeted identity attack"
            value={targeted}
        ...
        <InfoBox>
          MI-FGSM gives the best transferability across face recognition
          systems. Cosine similarity below 0.85 = identity successfully hidden.
        </InfoBox>
      </div>
            ...
            >
              {image && (
                <ResultImage
                  src={image.dataUrl}
                  label="Original"
                  downloadName="original_face.png"
                />
              )}
              <ResultImage
                src={result.cloaked_image}
      ...
      <Card style={{ marginBottom: "1.5rem" }}>
        ...
        >
          ...
          >
            ...
            <InfoBox>
              Runs FGSM, MI-FGSM, and PGD simultaneously with the same ε for a
              fair comparison.
            </InfoBox>
          </div>
        </div>
    ...
    <Card>
      <div style={{ overflowX: "auto" }}>
        ...
        >
          ...
          <tbody>
            {rows.map((row) => {
              const vals = COMPARE_METHODS.map(
                (m) => comparison[m]?.response?.quality_metrics?.[row.key],
              );
              const best = row.highGood
              ...
              {COMPARE_METHODS.map((m) => {
                ...
                return (
                  <td
                    key={m}
                    style={td(
                      fooled ? "var(--accent-lime)" : "var(--accent-red)",
                    )}
                  >
            ...
            <tr>
              ...
              {COMPARE_METHODS.map((m) => {
                const cls =
                  comparison[m]?.response?.cloaked_top3?.[0]?.class ?? "—";
                return (
                  <td key={m} style={td("var(--accent-cyan)")}>
                    {cls}
                  </td>
                );
              })}
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-void)" }}>
      ...
      <div
        style={{
          borderBottom: "1px solid var(--border-subtle)",
          background:
            "linear-gradient(180deg, rgba(184,255,63,0.03) 0%, transparent 100%)",
          padding: "1.5rem 2rem",
        }}
      >
      ...
      >
        ...
        >
          Mirage-AI v2 · MI-FGSM + Ensemble · ResNet50 / VGG16 / DenseNet121 ·
          FaceNet VGGFace2
        </span>
        <span
          style={{
